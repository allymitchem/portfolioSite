...
const About = () => {
    return (
        <div id ="about" >
            ...
            <h2> About Me</h2>
            <p id="aboutMeTextBox">
            I am a web developer currently living in Utah, but I was born and raised in Southern California, where I received my Bachelor of Science in biology at California State Polytechnic University, Pomona. After gaining six years of experience as a medical coder, I was compelled to embark on a new career. As a recent graduate of the Full-Stack Web Development cohort from Utah State University powered through Fullstack Academy, I am excited to begin my journey through tech and expand my skills learning various programming languages. 
            </p>
            <p id="aboutMeTextBox">
            As a military spouse, being able to maintain career skills that transcend geographical boundaries is extremely important. This has allowed me to acquire a sense of adaptability with my working life.
            </p>
            <p id="aboutMeTextBox">
